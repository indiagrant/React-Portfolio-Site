...
const SkillsSection = () => {
  return (
    <section id="skills">
      <h1 className="text-4xl font-bold text-center text-white my-2 mb-10">
        Skills
      </h1>
      <ul className="flex flex-wrap gap-4 justify-center items-center text-[#f472a8] md:text-lg lg:text-xl lg:pb-10 lg:pt-10 sm:text-md mb-20 ">
